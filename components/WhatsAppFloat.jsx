...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-neutral-950 shadow-lg shadow-black/35 hover:shadow-2xl hover:shadow-black/50 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 hover:-translate-y-1 animate-bounce-in group border border-neutral-800"
