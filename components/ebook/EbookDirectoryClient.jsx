            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {searchResults.map((r) => (
                <Link
                  key={r.s}
                  href={`/ebook/${r.c}/${r.u}/`}
                  className="group bg-white text-neutral-900 border border-neutral-200 dark:bg-white dark:text-neutral-900 rounded-2xl p-4 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-md transition-all flex flex-col justify-between"
                >
                  <div>
                    ...
                    <h3 className="font-extrabold text-xs sm:text-sm text-neutral-950 leading-snug line-clamp-2 mt-1 group-hover:underline">
                      {r.t}
                    </h3>
                    {r.a && (
                      <p className="text-[11px] text-neutral-500 font-serif line-clamp-1 mt-0.5">
                        {r.a}
                      </p>
                    )}
                  </div>
                  <div className="mt-3 pt-2 border-t border-neutral-100 flex items-center justify-between text-[10px] font-mono font-bold text-neutral-900">
                    <span className="text-neutral-500 uppercase">{r.c}</span>
