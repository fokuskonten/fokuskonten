...
/**
 * SidebarLaptopTools.jsx — Sidebar Kontainer Hitam Eksklusif Khusus Teknisi Laptop & Insinyur Motherboard
 * Mematuhi STANDAR_UI_WEB_OFFICIAL.md Pilar 2 (Monokrom Mutlak) & Pilar 5 (Teks & Chip Kontras)
 */
export default function SidebarLaptopTools() {
  const waUrl = 'https://wa.me/6285156942008?text=Halo%20FokusKonten%2C%20saya%20butuh%20bantuan%20teknis%20Skema%20dan%20Boardview%20Laptop'
  ...
  return (
    <div className="bg-neutral-950 text-white border border-neutral-800 rounded-2xl p-6 sm:p-8 shadow-xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-neutral-400 font-mono">Master Engineering</span>
      </div>

      {/* Main Title */}
      <div className="space-y-2">
        <h3 className="text-xl font-extrabold text-white tracking-tight leading-snug">
          Koleksi Skema &amp; Boardview Laptop
        </h3>
        <p className="text-xs text-neutral-300 leading-relaxed">
          Kompilasi berkas diagram skematik dan boardview CAD terlengkap untuk analisa jalur distribusi 19V, standby 3.3V/5V, dan pelacakan sinyal power sequence motherboard.
        </p>
      </div>
      ...
      <div className="space-y-2 border-t border-b border-neutral-800 py-4 text-xs font-mono text-neutral-200">
        <div className="flex items-center space-x-2">
          ...
          <span>Diagram Skema PDF Resolusi Tinggi</span>
        </div>
        <div className="flex items-center space-x-2">
          <span className="w-2 h-2 bg-white rounded-full"></span>
          <span>Boardview CAD, FZ &amp; BRD Multi-Layer</span>
        </div>
        <div className="flex items-center space-x-2">
          <span className="w-2 h-2 bg-white rounded-full"></span>
          <span>Panduan Pengukuran Jalur No Power</span>
        </div>
        <div className="flex items-center space-x-2">
          <span className="w-2 h-2 bg-white rounded-full"></span>
          <span>Akses Langsung Berkas Terverifikasi</span>
        </div>
      </div>
