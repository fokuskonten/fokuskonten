...
const socialLinks = [
  ...
  {
    name: 'TikTok',
    href: 'https://tiktok.com/@fokuskonten.my.id',
  ...
  {
    name: 'Twitter / X',
    href: 'https://twitter.com/fokuskonten',
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/fokuskonten',
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/fokuskonten',
      ...
      <div className="container-page pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-8 h-8 rounded-lg flex items-center justify-center text-neutral-400 transition-all duration-200 hover:text-brand-600 hover:bg-brand-50"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h3 className="font-display font-semibold text-xs text-neutral-900 tracking-wider uppercase mb-4">
                {title}
              </h3>
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-neutral-500 hover:text-brand-600 text-sm transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-10 pt-6 border-t border-neutral-200/60 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-neutral-400 text-xs">
            &copy; {new Date().getFullYear()} FokusKonten. Hak cipta dilindungi.
          </p>
          <div className="flex items-center gap-4 text-xs">
            <a href="https://wa.me/6285183011318" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-brand-600 transition-colors">
              +62 851-8301-1318
            </a>
            <span className="text-neutral-300">·</span>
            <a href="https://fokuskonten.my.id" className="text-neutral-400 hover:text-brand-600 transition-colors">
              fokuskonten.my.id
            </a>
          </div>
        </div>
