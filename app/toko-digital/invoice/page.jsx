...
function InvoiceContent() {
  ...
  useEffect(() => {
    ...
    if (found) {
      ...
      // Jika order tidak ditemukan di localStorage (kemungkinan dibuka di perangkat lain atau mode incognito)
      // Kita tetap set id-nya agar status order bisa di-polling dari server (di useEffect berikutnya).
      setOrder({
        orderId: orderId,
