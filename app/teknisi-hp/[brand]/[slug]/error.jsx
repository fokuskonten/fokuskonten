...
export default function ModelDetailError({ error, reset }) {
  return (
    <div className="bg-white border border-neutral-200 rounded-2xl p-8 text-center space-y-4 max-w-lg mx-auto my-12 shadow-md">
      ...
      <h2 className="text-xl font-extrabold text-neutral-950">Gagal Memuat Detail Model</h2>
      <p className="text-xs text-neutral-500 font-mono">{error?.message || 'Terjadi kendala koneksi data.'}</p>
      <button
        onClick={() => reset()}
