  ...
  if (fs.existsSync(webCatalogPath)) {
    try {
      ...
      const megaBundleDescription = [
        ...
        'Perpustakaan literatur digital terlengkap yang menghimpun lebih dari 2.470 ebook naskah pilihan dalam 18 rumpun keilmuan strategis. Dirancang sebagai sumber referensi komprehensif untuk mendampingi proses belajar, riset mandiri, peningkatan karir, serta perluasan wawasan intelektual tanpa batas.',
        '',
        'CAKUPAN 18 RUMPUN SILO KEILMUAN:',
        "• 01. Agama Islam & Tafsir (487 Ebook): Hadits shahih, kajian fiqih, sirah nabawiyah, tazkiyatun nufus, dan tafsir Al-Qur'an.",
        '• 02. Bisnis, Finansial & Investasi (312 Ebook): Manajemen keuangan, strategi marketing, analisis saham, dan perintisan usaha.',
        '• 03. Pengembangan Diri & Motivasi (248 Ebook): Transformasi kebiasaan, manajemen waktu, kepemimpinan, dan produktivitas.',
        '• 04. Novel, Sastra & Karya Fiksi (284 Ebook): Karya sastra klasik, novel inspiratif, fiksi terpilih, dan antologi cerita.',
        '• 05. Pendidikan, Riset & Akademik (195 Ebook): Diktat perkuliahan, metodologi penelitian, dan modul ajar terstruktur.',
        '• 06. Sains, Teknologi & Pengetahuan (142 Ebook): Eksplorasi sains alam, teknologi modern, dan ensiklopedia pengetahuan umum.',
        '• 07. Kesehatan, Medis & Nutrisi (130 Ebook): Referensi medis praktis, terapi herbal terpercaya, dan panduan gaya hidup sehat.',
        '• 08. Kuliner & Aneka Resep Masakan (126 Ebook): Kompilasi kuliner nusantara, takaran bumbu presisi, dan teknik memasak.',
        '• 09. Hukum & Perundang-Undangan (88 Ebook): Kompilasi hukum perdata, pidana, tata negara, dan kajian yuridis formal.',
        '• 10. Psikologi & Dinamika Perilaku (94 Ebook): Komunikasi interpersonal, kesehatan mental, dan analisis psikologi terapan.',
        '• 11. Pertanian, Peternakan & Agribisnis (76 Ebook): Agroteknologi terpadu, hidroponik, budidaya tanaman pangan, dan peternakan.',
        '• 12. Edukasi Anak & Pola Asuh Parenting (82 Ebook): Cerita bergambar edukatif, stimulasi karakter anak, dan pedoman keluarga.',
        '• 13. Karir, Profesi & Dunia Kerja (65 Ebook): Peningkatan keahlian profesional, wawancara kerja, dan etika perkantoran.',
        '• 14. Politik, Sosial & Kebijakan Publik (52 Ebook): Sosiologi kemasyarakatan, dinamika politik kenegaraan, dan kebijakan publik.',
        '• 15. Filsafat, Etika & Logika Pemikiran (41 Ebook): Kajian dialektika, seni bernalar kritis, epistemologi, dan filsafat hidup.',
        '• 16. Budaya, Tradisi & Sejarah Nusantara (38 Ebook): Warisan peradaban bangsa, adat istiadat nusantara, dan catatan sejarah.',
        '• 17. Majalah & Jurnal Digital Pilihan (32 Ebook): Edisi berkala, liputan tematik, dan rangkuman literasi visual berkualitas.',
        '• 18. Kamus & Referensi Bahasa Lengkap (58 Ebook): Tata bahasa, kosakata terstruktur, dan panduan kefasihan bahasa asing.',
        '',
